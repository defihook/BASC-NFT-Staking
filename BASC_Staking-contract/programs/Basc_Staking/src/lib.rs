...
pub struct StakeNftToPairPool<'info> {
    ...
    pub user_ape_token_account: Account<'info, TokenAccount>,
    ...
    pub dest_ape_nft_token_account: Account<'info, TokenAccount>,
    /// CHECK: This is not dangerous because we don't read or write from this account
    ...
    pub user_tiger_token_account: Account<'info, TokenAccount>,
    ...
    pub dest_tiger_nft_token_account: Account<'info, TokenAccount>,
    /// CHECK: This is not dangerous because we don't read or write from this account
